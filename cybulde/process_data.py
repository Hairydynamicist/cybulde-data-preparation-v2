...
def process_data(config: Config) -> None:
    github_user_name = "hairydynamicist"
    version = "v1"
    data_local_save_dir = "./data/raw"
    dvc_remote_repo = "https://github.com/Hairydynamicist/cybulde-data-v2.git"
    dvc_data_folder = "data/raw"
    github_access_token = access_secret_version("cybuldeproject", "cybulde-data-github-access-token")
